package com.shamela.library.presentaion.common
...
@Composable
fun SectionItem(modifier: Modifier, item: Section) {
    Row(
        modifier = modifier
            .fillMaxWidth(),
        ...
        Column(Modifier.fillMaxWidth(0.9f)) {
            ...
            Text(text = " عدد الكتب: ${item.numberOfBooks}", style = AppFonts.textNormal)
        }
