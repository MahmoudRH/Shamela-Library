...
class SearchAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    constructor(context: Context, dataBundle: Bundle) : super() {
        ...
        searchLocatorList = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            dataBundle.getParcelableArrayList("DATA", SearchLocator::class.java) ?: mutableListOf()
        }else{
            dataBundle.getParcelableArrayList("DATA") ?: mutableListOf()
        }
    }
        ...
        override fun onBind(position: Int) {
            ...
            when (searchLocator.searchItemType) {
                ...
                SearchItemType.SEARCH_RESULT_ITEM -> {
                    ...
                    spannableString.setSpan(BackgroundColorSpan(Color.YELLOW), from, to, 0)
